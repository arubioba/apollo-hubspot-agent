...
export function createApp({
  ...
  app.post("/api/runs/:id/discovery", route(req => handlers.startDiscovery(req.params.id)));
  app.get("/api/runs/:id/discovery", route(req => handlers.discoveryStatus(req.params.id)));
